...
GLfloat Grid::getSizeX()
{
	return xsize;
}

GLfloat Grid::getSizeZ()
{
	return zsize;
}
...
for (int x=0; x<xsteps; x++)
	for (int z=0; z<zsteps; z++)
	{
	glVertex3f((GLfloat)xdelta*x, (GLfloat)0.0, (GLfloat)zdelta*z + zdelta);
	glVertex3f((GLfloat)xdelta*x + xdelta, (GLfloat)0.0, (GLfloat)zdelta*z + zdelta);
	glVertex3f((GLfloat)xdelta*x + xdelta, (GLfloat)0.0, (GLfloat)zdelta*z);
	glVertex3f((GLfloat)xdelta*x, (GLfloat)0.0, (GLfloat)zdelta*z); // grid above and below surface 
