...
// vec4 dot multiplication
float dot(const vec4& u, const vec4& v); 

// doing the calculation of u * v and return in retV
// where u is a homogenous vector and v is a matrix of 16 elements. 
// Note: u * v is not equal to v * u. Non-commutive. 
// Use this function where v matrix is colomn major. 
